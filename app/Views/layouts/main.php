...
<nav class="navbar navbar-expand-lg navi-color p-4 border-bottom">
  <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item me-3"><a class="nav-link fw-bold hov text-center mt-lg-0 mt-4" href="<?= base_url('layouts/home'); ?>">Dashboard</a></li>
          <li class="nav-item me-3"><a class="nav-link fw-bold hov text-center mt-lg-0 mt-3"  href="<?= base_url('layouts/manage_task'); ?>">Tasks</a></li>
          <li class="nav-item me-3"><a class="nav-link fw-bold hov text-center mt-lg-0 mt-3"  href="<?= base_url('layouts/about'); ?>">About</a></li>
        </ul>
      </div>
